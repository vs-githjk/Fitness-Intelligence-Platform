...
import { useMorningBriefTheme } from '../lib/useMorningBriefTheme'
...
export function AppShell({ children, morningBrief = false }: { children: ReactNode; morningBrief?: boolean }) {
  ...
  // Route-scoped Today theme (dark only within this migrated subtree). Resolved
  // unconditionally to respect the hooks rule; applied only in morningBrief mode.
  const briefTheme = useMorningBriefTheme()
