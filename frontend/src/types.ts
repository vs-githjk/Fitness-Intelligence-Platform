...
export type ScheduledWorkoutStatus = 'scheduled' | 'in_progress' | 'completed' | 'partial' | 'cancelled' | 'superseded'
...
export interface RecordedBestsResponse { start_date: string; end_date: string; exercises: RecordedBestExercise[] }
export interface CoachSessionSummary { workout_session_id: string; scheduled_workout_id: string; scheduled_date: string; workout_name: string | null; program_name: string | null; program_version_number: number | null; status: WorkoutSessionStatus; classification: WorkoutClassification; started_at: string; completed_at: string | null; ended_at: string | null; actual_duration_minutes: number | null; session_rpe: string | null; planned_session_load: number | null; completed_session_load: number | null; session_volume_kg: string | null; open_safety_report_count: number }
