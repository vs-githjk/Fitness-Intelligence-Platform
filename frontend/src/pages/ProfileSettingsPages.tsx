...
function ThemeCard() {
  ...
  return (
    <Card className="space-y-3">
      <div><h2 className="text-lg font-semibold">Theme</h2><p className="mt-1 text-sm text-secondary">Choose how FitIntel looks. This changes presentation only and is saved to your account.</p></div>
